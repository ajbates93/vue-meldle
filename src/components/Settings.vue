<template>
  ...
  <div class="z-50 w-2/4 fixed p-5 top-2/4 left-2/4 bg-white shadow-xl rounded-lg transition-all" style="transform: translate(-50%, -50%); max-width: 350px;" :class="store.state.settings.showSettings ? 'opacity-100 visible' : 'opacity-0 hidden'">
